...
class mSubat19Quiz: UIViewController,  GADInterstitialDelegate   {
    
    var fullScreenads :GADInterstitial!
    
    let allQuestions = mSubat19Bank()
    ...
    override func viewDidLoad() {
        ...
        title = "Motor Şubat 2019 E-Sınav"
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if UserDefaults.standard.object(forKey: "vmCSubat19") != nil {
            self.correct = UserDefaults.standard.object(forKey: "vmCSubat19") as! Int
        }
        if UserDefaults.standard.object(forKey: "vmISubat19") != nil {
            self.incorrect = UserDefaults.standard.object(forKey: "vmISubat19") as! Int
        }
        
        let mSubat19 = segue.destination as! motor17
        mSubat19.correctSubat19 = correct
        mSubat19.incorrectSubat19 = incorrect
        mSubat19.puanSubat19 = String(correct*2)
    }
    ...
    func resultSave() {
        ...
        result.dersadi = "Motor Şubat 2019 E-Sınav"
        result.tarih = tarihh
