...
class mNisan18: UIViewController, GADInterstitialDelegate   {
    
    var fullScreenads :GADInterstitial!
    
    let allQuestions = mNisan18Bank()
    ...
    var mNisan18 = ["null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null","null","null","null", "null","null","null","null"]
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        title = "Motor (21 Nisan 2018)"
        
        if defaults.object(forKey: "mNisan18") != nil {
            self.mNisan18 = defaults.object(forKey: "mNisan18") as! [String]
            UserDefaults.standard.synchronize()
        }
        
        if defaults.object(forKey: "vmCNisan18") != nil {
            self.correct = defaults.object(forKey: "vmCNisan18") as! Int
            UserDefaults.standard.synchronize()
        }
        
        if defaults.object(forKey: "vmINisan18") != nil {
            self.incorrect = defaults.object(forKey: "vmINisan18") as! Int
            UserDefaults.standard.synchronize()
        }
    ...
    @IBAction func answerPressed(_ sender: UIButton) {
        ...
        //        hav not SAVE .........................................................................
        if mNisan18[questionNumber] == "null" {
            ...
            if sender.tag == selectedAnswer {
                ...
                correctText.text = "Doğru: \(correct)"
                if sender.tag == 1 {
                    mNisan18[questionNumber] = "1"
                    defaults.set(mNisan18, forKey: "mNisan18")
                }
                if sender.tag == 2 {
                    mNisan18[questionNumber] = "2"
                    defaults.set(mNisan18, forKey: "mNisan18")
                }
                if sender.tag == 3 {
                    mNisan18[questionNumber] = "3"
                    defaults.set(mNisan18, forKey: "mNisan18")
                }
                if sender.tag == 4 {
                    mNisan18[questionNumber] = "4"
                    defaults.set(mNisan18, forKey: "mNisan18")
                }
            } else {
                print("wrong")
            ...
            if mNisan18[questionNumber] != String(selectedAnswer) {
                if sender.tag == selectedAnswer {
                    print("correct")
    ...
    func StartSave() {
        if optionA.tag == Int(mNisan18[questionNumber]) && selectedAnswer == 1 {
        ...
        if optionB.tag == Int(mNisan18[questionNumber]) && selectedAnswer == 2 {
            answerText.text = "Önceki Cevap: Doğru"
            answerText.textColor = UIColor(red: 0, green: 0.5686, blue: 0.0471, alpha: 1.0)
        }
        if optionB.tag == Int(mNisan18[questionNumber]) && selectedAnswer != 2 {
        ...
        if optionC.tag == Int(mNisan18[questionNumber]) && selectedAnswer == 3 {
            answerText.text = "Önceki Cevap: Doğru"
            answerText.textColor = UIColor(red: 0, green: 0.5686, blue: 0.0471, alpha: 1.0)
        }
        if optionC.tag == Int(mNisan18[questionNumber]) && selectedAnswer != 3 {
        ...
        if optionD.tag == Int(mNisan18[questionNumber]) && selectedAnswer == 4 {
            answerText.text = "Önceki Cevap: Doğru"
            answerText.textColor = UIColor(red: 0, green: 0.5686, blue: 0.0471, alpha: 1.0)
        }
        if optionD.tag == Int(mNisan18[questionNumber]) && selectedAnswer != 4 {
    ...
    func formating() {
        ...
        let ok = UIAlertAction(title: "EVET", style: UIAlertAction.Style.default, handler: {(action) -> Void in
            ...
            self.correct = 0
            self.incorrect = 0
            self.defaults.removeObject(forKey: "mNisan18")
            self.defaults.synchronize()
            self.correctText.text = "Doğru: \(self.correct)"
            self.wrongText.text = "Yanlış: \(self.incorrect)"
            self.mNisan18 = ["null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null","null","null", "null","null","null","null"]
            if self.mNisan18[self.questionNumber] == "null" {
    ...
    func alert(){
        ...
        let ok = UIAlertAction(title: "TAMAM", style: UIAlertAction.Style.default, handler: {(action) -> Void in
            ...
            UserDefaults.standard.set(self.correct, forKey: "vmCNisan18")
            UserDefaults.standard.synchronize()
            UserDefaults.standard.set(self.incorrect, forKey: "vmINisan18")
            UserDefaults.standard.synchronize()
            self.resultSave()
            self.performSegue(withIdentifier: "smNisan18", sender: self)
        })
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if UserDefaults.standard.object(forKey: "vmCNisan18") != nil {
            self.correct = UserDefaults.standard.object(forKey: "vmCNisan18") as! Int
        }
        if UserDefaults.standard.object(forKey: "vmINisan18") != nil {
            self.incorrect = UserDefaults.standard.object(forKey: "vmINisan18") as! Int
        }
        
        let msubat18 = segue.destination as! motor17
        msubat18.correctNisan18 = correct
        msubat18.incorrectNisan18 = incorrect
    }
    ...
    func resultSave() {
        ...
        result.dersadi = "21 Nisan 2018 Motor"
        result.tarih = tarihh
