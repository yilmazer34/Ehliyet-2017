...
class tOcak19Quiz: UIViewController,  GADInterstitialDelegate   {
    
    var fullScreenads :GADInterstitial!
    
    let allQuestions = tOcak19Bank()
    ...
    override func viewDidLoad() {
        ...
        title = "Trafik Ocak 2019 E-Sınav"
    ...
    func alert(){
        ...
        let ok = UIAlertAction(title: "TAMAM", style: UIAlertAction.Style.default, handler: {(action) -> Void in
            ...
            UserDefaults.standard.set(self.correct, forKey: "vtCOcak19")
            UserDefaults.standard.synchronize()
            UserDefaults.standard.set(self.incorrect, forKey: "vtIOcak19")
            UserDefaults.standard.synchronize()
            self.resultSave()
            self.performSegue(withIdentifier: "tOcak19", sender: self)
        })
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if UserDefaults.standard.object(forKey: "vtCOcak19") != nil {
            self.correct = UserDefaults.standard.object(forKey: "vtCOcak19") as! Int
        }
        if UserDefaults.standard.object(forKey: "vtIOcak19") != nil {
            self.incorrect = UserDefaults.standard.object(forKey: "vtIOcak19") as! Int
        }
        
        let tOcak19 = segue.destination as! trafik17
        tOcak19.correctOcak19 = correct
        tOcak19.incorrectOcak19 = incorrect
        tOcak19.puanOcak19 = String(correct*2)
    }
    ...
    func resultSave() {
        ...
        result.dersadi = "Trafik Ocak 2019 E-Sınav"
        result.tarih = tarihh
