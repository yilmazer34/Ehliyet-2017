...
class tNisan18Quiz: UIViewController, GADInterstitialDelegate   {
    
    var fullScreenads :GADInterstitial!
    
    let allQuestions = tNisan18Bank()
    ...
    var TNisan18 = ["null", "null","null","null","null","null","null","null", "null","null","null","null","null","null","null", "null","null","null","null","null","null","null","null","null"]
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        title = "Trafik (21 Nisan 2018)"
        
        if defaults.object(forKey: "TNisan18") != nil {
            self.TNisan18 = defaults.object(forKey: "TNisan18") as! [String]
            UserDefaults.standard.synchronize()
        }
        
        if defaults.object(forKey: "vtCNisan18") != nil {
            self.correct = defaults.object(forKey: "vtCNisan18") as! Int
            UserDefaults.standard.synchronize()
        }
        
        if defaults.object(forKey: "vtINisan18") != nil {
            self.incorrect = defaults.object(forKey: "vtINisan18") as! Int
            UserDefaults.standard.synchronize()
        }
    ...
    @IBAction func answerPressed(_ sender: UIButton) {
        ...
        //        hav not SAVE .........................................................................
        if TNisan18[questionNumber] == "null" {
            ...
            if sender.tag == selectedAnswer {
                ...
                correctText.text = "Doğru: \(correct)"
                if sender.tag == 1 {
                    TNisan18[questionNumber] = "1"
                    defaults.set(TNisan18, forKey: "TNisan18")
                }
                if sender.tag == 2 {
                    TNisan18[questionNumber] = "2"
                    defaults.set(TNisan18, forKey: "TNisan18")
                }
                if sender.tag == 3 {
                    TNisan18[questionNumber] = "3"
                    defaults.set(TNisan18, forKey: "TNisan18")
                }
                if sender.tag == 4 {
                    TNisan18[questionNumber] = "4"
                    defaults.set(TNisan18, forKey: "TNisan18")
                }
            } else {
                print("wrong")
            ...
            if TNisan18[questionNumber] != String(selectedAnswer) {
                if sender.tag == selectedAnswer {
                    print("correct")
    ...
    func StartSave() {
        if optionA.tag == Int(TNisan18[questionNumber]) && selectedAnswer == 1 {
        ...
        if optionB.tag == Int(TNisan18[questionNumber]) && selectedAnswer == 2 {
            answerText.text = "Önceki Cevap: Doğru"
            answerText.textColor = UIColor(red: 0, green: 0.5686, blue: 0.0471, alpha: 1.0)
        }
        if optionB.tag == Int(TNisan18[questionNumber]) && selectedAnswer != 2 {
        ...
        if optionC.tag == Int(TNisan18[questionNumber]) && selectedAnswer == 3 {
            answerText.text = "Önceki Cevap: Doğru"
            answerText.textColor = UIColor(red: 0, green: 0.5686, blue: 0.0471, alpha: 1.0)
        }
        if optionC.tag == Int(TNisan18[questionNumber]) && selectedAnswer != 3 {
        ...
        if optionD.tag == Int(TNisan18[questionNumber]) && selectedAnswer == 4 {
            answerText.text = "Önceki Cevap: Doğru"
            answerText.textColor = UIColor(red: 0, green: 0.5686, blue: 0.0471, alpha: 1.0)
        }
        if optionD.tag == Int(TNisan18[questionNumber]) && selectedAnswer != 4 {
    ...
    func formating() {
        ...
        let ok = UIAlertAction(title: "EVET", style: UIAlertAction.Style.default, handler: {(action) -> Void in
            ...
            self.correct = 0
            self.incorrect = 0
            self.defaults.removeObject(forKey: "TNisan18")
            self.defaults.synchronize()
            self.correctText.text = "Doğru: \(self.correct)"
            self.wrongText.text = "Yanlış: \(self.incorrect)"
            self.TNisan18 = ["null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null"]
            if self.TNisan18[self.questionNumber] == "null" {
    ...
    func alert(){
        ...
        let ok = UIAlertAction(title: "TAMAM", style: UIAlertAction.Style.default, handler: {(action) -> Void in
            ...
            UserDefaults.standard.set(self.correct, forKey: "vtCNisan18")
            UserDefaults.standard.synchronize()
            UserDefaults.standard.set(self.incorrect, forKey: "vtINisan18")
            UserDefaults.standard.synchronize()
            self.resultSave()
            self.performSegue(withIdentifier: "stNisan18", sender: self)
        })
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if UserDefaults.standard.object(forKey: "vtCNisan18") != nil {
            self.correct = UserDefaults.standard.object(forKey: "vtCNisan18") as! Int
        }
        if UserDefaults.standard.object(forKey: "vtINisan18") != nil {
            self.incorrect = UserDefaults.standard.object(forKey: "vtINisan18") as! Int
        }
        
        let tNisan18 = segue.destination as! trafik17
        tNisan18.correctNisan18 = correct
        tNisan18.incorrectNisan18 = incorrect
        tNisan18.puanNisan18 = String(correct*2)
    }
    ...
    func resultSave() {
        ...
        result.dersadi = "21 Nisan 2018 Trafik ve Çevre"
        result.tarih = tarihh
