...
class tMarch19Quiz: UIViewController,  GADInterstitialDelegate   {
    
    var fullScreenads :GADInterstitial!
    
    let allQuestions = tMarch19Bank()
    ...
    override func viewDidLoad() {
        ...
        title = "Trafik Mart 2019 E-Sınav"
    ...
    func alert(){
        ...
        let ok = UIAlertAction(title: "TAMAM", style: UIAlertAction.Style.default, handler: {(action) -> Void in
            ...
            UserDefaults.standard.set(self.correct, forKey: "vtCMarch19")
            UserDefaults.standard.synchronize()
            UserDefaults.standard.set(self.incorrect, forKey: "vtIMarch19")
            UserDefaults.standard.synchronize()
            self.resultSave()
            self.performSegue(withIdentifier: "tMarch19", sender: self)
        })
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if UserDefaults.standard.object(forKey: "vtCMarch19") != nil {
            self.correct = UserDefaults.standard.object(forKey: "vtCMarch19") as! Int
        }
        if UserDefaults.standard.object(forKey: "vtIMarch19") != nil {
            self.incorrect = UserDefaults.standard.object(forKey: "vtIMarch19") as! Int
        }
        
        let tMarch19 = segue.destination as! trafik17
        tMarch19.correctMarch19 = correct
        tMarch19.incorrectMarch19 = incorrect
        tMarch19.puanMarch19 = String(correct*2)
    }
    ...
    func resultSave() {
        ...
        result.dersadi = "Trafik Mart 2019 E-Sınav"
        result.tarih = tarihh
