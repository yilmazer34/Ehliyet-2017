...
class taSubat19Quiz: UIViewController,  GADInterstitialDelegate   {
    ...
    override func viewDidLoad() {
        ...
        title = "Trafik Adabı Şubat 2019 E-Sınav"
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let Subat19 = segue.destination as! trafikAdabi17
    ...
    func resultSave() {
        ...
        result.dersadi = "Trafik Adabı Şubat 2019 E-Sınav"
        result.tarih = tarihh
