...
class taOcak19Quiz: UIViewController,  GADInterstitialDelegate   {
    
    var fullScreenads :GADInterstitial!
    
    let allQuestions = taOcak19Bank()
    ...
    override func viewDidLoad() {
        ...
        title = "Trafik Adabı Ocak 2019 E-Sınav"
...
//            print("soru numarası \(questionNumber)")
    ...
    func alert(){
        ...
        let ok = UIAlertAction(title: "TAMAM", style: UIAlertAction.Style.default, handler: {(action) -> Void in
            ...
            UserDefaults.standard.set(self.correct, forKey: "vaCOcak19")
            UserDefaults.standard.synchronize()
            UserDefaults.standard.set(self.incorrect, forKey: "vaIOcak19")
            UserDefaults.standard.synchronize()
            
            self.resultSave()
            self.performSegue(withIdentifier: "saOcak19", sender: self)
        })
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if UserDefaults.standard.object(forKey: "vaCOcak19") != nil {
            self.correct = UserDefaults.standard.object(forKey: "vaCOcak19") as! Int
        }
        if UserDefaults.standard.object(forKey: "vaIOcak19") != nil {
            self.incorrect = UserDefaults.standard.object(forKey: "vaIOcak19") as! Int
        }
        
        let Ocak19 = segue.destination as! trafikAdabi17
        Ocak19.correctOcak19 = correct
        Ocak19.incorrectOcak19 = incorrect
        Ocak19.puanOcak19 = String(correct*2)
    }
    ...
    func resultSave() {
        ...
        result.dersadi = "Trafik Adabı Ocak 2019 E-Sınav"
        result.tarih = tarihh
