...
class taAgustos18Quiz: UIViewController, GADInterstitialDelegate   {
    
    var fullScreenads :GADInterstitial!
    
    let allQuestions = taAgustos18Bank()
    ...
    var TAagustos18 = ["null", "null","null","null","null","null","null"]
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        title = "Trafik Adabı (4 Ağustos 2018)"
        
        if defaults.object(forKey: "TAagustos18") != nil {
            self.TAagustos18 = defaults.object(forKey: "TAagustos18") as! [String]
            UserDefaults.standard.synchronize()
        }
        
        if defaults.object(forKey: "vaCAgustos18") != nil {
            self.correct = defaults.object(forKey: "vaCAgustos18") as! Int
            UserDefaults.standard.synchronize()
        }
        
        if defaults.object(forKey: "vaIAgustos18") != nil {
            self.incorrect = defaults.object(forKey: "vaIAgustos18") as! Int
            UserDefaults.standard.synchronize()
        }
    ...
    @IBAction func answerPressed(_ sender: UIButton) {
        ...
        //        hav not SAVE .........................................................................
        if TAagustos18[questionNumber] == "null" {
            ...
            if sender.tag == selectedAnswer {
                ...
                correctText.text = "Doğru: \(correct)"
                if sender.tag == 1 {
                    TAagustos18[questionNumber] = "1"
                    defaults.set(TAagustos18, forKey: "TAagustos18")
                }
                if sender.tag == 2 {
                    TAagustos18[questionNumber] = "2"
                    defaults.set(TAagustos18, forKey: "TAagustos18")
                }
                if sender.tag == 3 {
                    TAagustos18[questionNumber] = "3"
                    defaults.set(TAagustos18, forKey: "TAagustos18")
                }
                if sender.tag == 4 {
                    TAagustos18[questionNumber] = "4"
                    defaults.set(TAagustos18, forKey: "TAagustos18")
                }
            } else {
                print("wrong")
            ...
            if TAagustos18[questionNumber] != String(selectedAnswer) {
                if sender.tag == selectedAnswer {
                    print("correct")
                    Correct()
                    sender.backgroundColor = UIColor.green
    ...
    func StartSave() {
        if optionA.tag == Int(TAagustos18[questionNumber]) && selectedAnswer == 1 {
        ...
        if optionB.tag == Int(TAagustos18[questionNumber]) && selectedAnswer == 2 {
            answerText.text = "Önceki Cevap: Doğru"
            answerText.textColor = UIColor(red: 0, green: 0.5686, blue: 0.0471, alpha: 1.0)
        }
        if optionB.tag == Int(TAagustos18[questionNumber]) && selectedAnswer != 2 {
        ...
        if optionC.tag == Int(TAagustos18[questionNumber]) && selectedAnswer == 3 {
            answerText.text = "Önceki Cevap: Doğru"
            answerText.textColor = UIColor(red: 0, green: 0.5686, blue: 0.0471, alpha: 1.0)
        }
        if optionC.tag == Int(TAagustos18[questionNumber]) && selectedAnswer != 3 {
        ...
        if optionD.tag == Int(TAagustos18[questionNumber]) && selectedAnswer == 4 {
            answerText.text = "Önceki Cevap: Doğru"
            answerText.textColor = UIColor(red: 0, green: 0.5686, blue: 0.0471, alpha: 1.0)
        }
        if optionD.tag == Int(TAagustos18[questionNumber]) && selectedAnswer != 4 {
    ...
    func formating() {
        ...
        let ok = UIAlertAction(title: "EVET", style: UIAlertActionStyle.default, handler: {(action) -> Void in
            ...
            self.correct = 0
            self.incorrect = 0
            self.defaults.removeObject(forKey: "TAagustos18")
            self.defaults.synchronize()
            self.correctText.text = "Doğru: \(self.correct)"
            self.wrongText.text = "Yanlış: \(self.incorrect)"
            self.TAagustos18 = ["null", "null","null","null","null","null","null"]
            if self.TAagustos18[self.questionNumber] == "null" {
    ...
    func alert(){
        ...
        let ok = UIAlertAction(title: "TAMAM", style: UIAlertActionStyle.default, handler: {(action) -> Void in
            ...
            UserDefaults.standard.set(self.correct, forKey: "vaCAgustos18")
            UserDefaults.standard.synchronize()
            UserDefaults.standard.set(self.incorrect, forKey: "vaIAgustos18")
            UserDefaults.standard.synchronize()
            self.resultSave()
            self.performSegue(withIdentifier: "saAgustos18", sender: self)
        })
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if UserDefaults.standard.object(forKey: "vaCAgustos18") != nil {
            self.correct = UserDefaults.standard.object(forKey: "vaCAgustos18") as! Int
        }
        if UserDefaults.standard.object(forKey: "vaIAgustos18") != nil {
            self.incorrect = UserDefaults.standard.object(forKey: "vaIAgustos18") as! Int
        }
        
        let aAgustos18 = segue.destination as! trafikAdabi17
        aAgustos18.correctAgustos18 = correct
        aAgustos18.incorrectAgustos18 = incorrect
        aAgustos18.puanAgustos18 = String(correct*2)
    }
    ...
    func resultSave() {
        ...
        result.dersadi = "4 Ağustos 2018 Trafik Adabı"
        result.tarih = tarihh
