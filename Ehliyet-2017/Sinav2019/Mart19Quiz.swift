...
//  Ehliyet-2017
//
//  Created by YILMAZ ER on 3/28/19.
...
class Mart19Quiz: UIViewController,  GADInterstitialDelegate   {
    
    var fullScreenads :GADInterstitial!
    
    let allQuestions = Mart19Bank()
    ...
    func alert(){
        ...
        let ok = UIAlertAction(title: "TAMAM", style: UIAlertAction.Style.default, handler: {(action) -> Void in
            ...
            UserDefaults.standard.set(self.correct, forKey: "vCMart19")
            UserDefaults.standard.synchronize()
            UserDefaults.standard.set(self.incorrect, forKey: "vIMart19")
            UserDefaults.standard.synchronize()
            self.resultSave()
            self.performSegue(withIdentifier: "Mart19", sender: self)
        })
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if UserDefaults.standard.object(forKey: "vCMart19") != nil {
            self.correct = UserDefaults.standard.object(forKey: "vCMart19") as! Int
        }
        if UserDefaults.standard.object(forKey: "vIMart19") != nil {
            self.incorrect = UserDefaults.standard.object(forKey: "vIMart19") as! Int
        }
        
        let Mart19 = segue.destination as! List2019
    ...
    func resultSave() {
        ...
        result.dersadi = "Mart 2019 E-Sınav"
        result.tarih = tarihh
