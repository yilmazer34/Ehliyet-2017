...
class Subat19Quiz: UIViewController,  GADInterstitialDelegate   {
    
    var fullScreenads :GADInterstitial!
    
    let allQuestions = Subat19Bank()
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if UserDefaults.standard.object(forKey: "vCSubat19") != nil {
            self.correct = UserDefaults.standard.object(forKey: "vCSubat19") as! Int
        }
        if UserDefaults.standard.object(forKey: "vISubat19") != nil {
            self.incorrect = UserDefaults.standard.object(forKey: "vISubat19") as! Int
        }
        
        let Subat19 = segue.destination as! List2019
        Subat19.correctSubat19 = correct
        Subat19.incorrectSubat19 = incorrect
        Subat19.puanSubat19 = String(correct*2)
    }
    ...
    func resultSave() {
        ...
        result.dersadi = "Şubat 2019 E-Sınav"
        result.tarih = tarihh
