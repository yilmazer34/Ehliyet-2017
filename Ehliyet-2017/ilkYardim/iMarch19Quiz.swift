...
class iMarch19Quiz: UIViewController,  GADInterstitialDelegate   {
    
    var fullScreenads :GADInterstitial!
    
    let allQuestions = iMarch19Bank()
    ...
    override func viewDidLoad() {
        ...
        title = "İlkyardım Mart 2019 E-Sınav"
    ...
    func alert(){
        ...
        let ok = UIAlertAction(title: "TAMAM", style: UIAlertAction.Style.default, handler: {(action) -> Void in
            ...
            UserDefaults.standard.set(self.correct, forKey: "iCMarch19")
            UserDefaults.standard.synchronize()
            UserDefaults.standard.set(self.incorrect, forKey: "iIMarch19")
            UserDefaults.standard.synchronize()
            self.resultSave()
            self.performSegue(withIdentifier: "iMarch19", sender: self)
        })
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if UserDefaults.standard.object(forKey: "iCMarch19") != nil {
            self.correct = UserDefaults.standard.object(forKey: "iCMarch19") as! Int
        }
        if UserDefaults.standard.object(forKey: "iIMarch19") != nil {
            self.incorrect = UserDefaults.standard.object(forKey: "iIMarch19") as! Int
        }
        
        let iMarch19 = segue.destination as! ilkyardim17
        iMarch19.correctMarch19 = Int(correct)
        iMarch19.incorrectMarch19 = incorrect
        iMarch19.puanMarch19 = String((correct/13)*100)
    }
    ...
    func resultSave() {
        ...
        result.dersadi = "İlkyardım Mart 2019 E-Sınav"
        result.tarih = tarihh
