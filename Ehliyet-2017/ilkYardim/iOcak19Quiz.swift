...
class iOcak19Quiz: UIViewController,  GADInterstitialDelegate   {
    
    var fullScreenads :GADInterstitial!
    
    let allQuestions = iOcak19Bank()
    ...
    override func viewDidLoad() {
        ...
        title = "İlkyardım Ocak 2019 E-Sınav"
    ...
    func alert(){
        ...
        let ok = UIAlertAction(title: "TAMAM", style: UIAlertAction.Style.default, handler: {(action) -> Void in
            ...
            UserDefaults.standard.set(self.correct, forKey: "iCOcak19")
            UserDefaults.standard.synchronize()
            UserDefaults.standard.set(self.incorrect, forKey: "iIOcak19")
            UserDefaults.standard.synchronize()
            self.resultSave()
            self.performSegue(withIdentifier: "iOcak19", sender: self)
        })
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if UserDefaults.standard.object(forKey: "iCOcak19") != nil {
            self.correct = UserDefaults.standard.object(forKey: "iCOcak19") as! Int
        }
        if UserDefaults.standard.object(forKey: "iIOcak19") != nil {
            self.incorrect = UserDefaults.standard.object(forKey: "iIOcak19") as! Int
        }
        
        let iOcak19 = segue.destination as! ilkyardim17
        iOcak19.correctOcak19 = correct
        iOcak19.incorrectOcak19 = incorrect
        iOcak19.puanOcak19 = String(correct*2)
    }
    ...
    func resultSave() {
        ...
        result.dersadi = "İlkyardım Ocak 2019 E-Sınav"
        result.tarih = tarihh
