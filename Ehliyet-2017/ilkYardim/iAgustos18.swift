...
class iAgustos18: UIViewController, GADInterstitialDelegate   {
    ...
    var iAgustos18 = ["null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null"]
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        title = "İlk Yardım (4 Agustos 2018)"
        
        if defaults.object(forKey: "iAgustos18") != nil {
            self.iAgustos18 = defaults.object(forKey: "iAgustos18") as! [String]
            UserDefaults.standard.synchronize()
        }
        
        if defaults.object(forKey: "viCAgustos18") != nil {
            self.correct = defaults.object(forKey: "viCAgustos18") as! Int
            UserDefaults.standard.synchronize()
        }
        
        if defaults.object(forKey: "viIAgustos18") != nil {
            self.incorrect = defaults.object(forKey: "viIAgustos18") as! Int
            UserDefaults.standard.synchronize()
        }
    ...
    @IBAction func answerPressed(_ sender: UIButton) {
        ...
        //        hav not SAVE .........................................................................
        if iAgustos18[questionNumber] == "null" {
            ...
            if sender.tag == selectedAnswer {
                ...
                correctText.text = "Doğru: \(correct)"
                if sender.tag == 1 {
                    iAgustos18[questionNumber] = "1"
                    defaults.set(iAgustos18, forKey: "iAgustos18")
                }
                if sender.tag == 2 {
                    iAgustos18[questionNumber] = "2"
                    defaults.set(iAgustos18, forKey: "iAgustos18")
                }
                if sender.tag == 3 {
                    iAgustos18[questionNumber] = "3"
                    defaults.set(iAgustos18, forKey: "iAgustos18")
                }
                if sender.tag == 4 {
                    iAgustos18[questionNumber] = "4"
                    defaults.set(iAgustos18, forKey: "iAgustos18")
                }
            } else {
                print("wrong")
            ...
            if iAgustos18[questionNumber] != String(selectedAnswer) {
                if sender.tag == selectedAnswer {
                    print("correct")
    ...
    func StartSave() {
        if optionA.tag == Int(iAgustos18[questionNumber]) && selectedAnswer == 1 {
        ...
        if optionB.tag == Int(iAgustos18[questionNumber]) && selectedAnswer == 2 {
            answerText.text = "Önceki Cevap: Doğru"
            answerText.textColor = UIColor(red: 0, green: 0.5686, blue: 0.0471, alpha: 1.0)
        }
        if optionB.tag == Int(iAgustos18[questionNumber]) && selectedAnswer != 2 {
        ...
        if optionC.tag == Int(iAgustos18[questionNumber]) && selectedAnswer == 3 {
            answerText.text = "Önceki Cevap: Doğru"
            answerText.textColor = UIColor(red: 0, green: 0.5686, blue: 0.0471, alpha: 1.0)
        }
        if optionC.tag == Int(iAgustos18[questionNumber]) && selectedAnswer != 3 {
        ...
        if optionD.tag == Int(iAgustos18[questionNumber]) && selectedAnswer == 4 {
            answerText.text = "Önceki Cevap: Doğru"
            answerText.textColor = UIColor(red: 0, green: 0.5686, blue: 0.0471, alpha: 1.0)
        }
        if optionD.tag == Int(iAgustos18[questionNumber]) && selectedAnswer != 4 {
    ...
    func formating() {
        ...
        let ok = UIAlertAction(title: "EVET", style: UIAlertAction.Style.default, handler: {(action) -> Void in
            ...
            self.correct = 0
            self.incorrect = 0
            self.defaults.removeObject(forKey: "iAgustos18")
            self.defaults.synchronize()
            self.correctText.text = "Doğru: \(self.correct)"
            self.wrongText.text = "Yanlış: \(self.incorrect)"
            self.iAgustos18 = ["null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null","null","null", "null","null","null","null"]
            if self.iAgustos18[self.questionNumber] == "null" {
    ...
    func alert(){
        ...
        let ok = UIAlertAction(title: "TAMAM", style: UIAlertAction.Style.default, handler: {(action) -> Void in
            ...
            UserDefaults.standard.set(self.correct, forKey: "viCAgustos18")
            UserDefaults.standard.synchronize()
            UserDefaults.standard.set(self.incorrect, forKey: "viIAgustos18")
            UserDefaults.standard.synchronize()
            self.resultSave()
            self.performSegue(withIdentifier: "siAgustos18", sender: self)
        })
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if UserDefaults.standard.object(forKey: "viCAgustos18") != nil {
            self.correct = UserDefaults.standard.object(forKey: "viCAgustos18") as! Int
        }
        if UserDefaults.standard.object(forKey: "viIAgustos18") != nil {
            self.incorrect = UserDefaults.standard.object(forKey: "viIAgustos18") as! Int
        }
        
        let iAgustos18 = segue.destination as! ilkyardim17
        iAgustos18.correctAgustos18 = correct
        iAgustos18.incorrectAgustos18 = incorrect
        iAgustos18.puanAgustos18 = String(correct*(100/12))
    }
    ...
    func resultSave() {
        ...
        result.dersadi = "4 Agustos 2018 İLK YARDIM"
        result.tarih = tarihh
