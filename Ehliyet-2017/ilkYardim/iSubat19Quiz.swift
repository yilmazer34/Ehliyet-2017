...
class iSubat19Quiz: UIViewController,  GADInterstitialDelegate   {
    
    var fullScreenads :GADInterstitial!
    
    let allQuestions = iSubat19Bank()
    ...
    override func viewDidLoad() {
        ...
        title = "İlkyardım Şubat 2019 E-Sınav"
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if UserDefaults.standard.object(forKey: "iCSubat19") != nil {
            self.correct = UserDefaults.standard.object(forKey: "iCSubat19") as! Int
        }
        if UserDefaults.standard.object(forKey: "iISubat19") != nil {
            self.incorrect = UserDefaults.standard.object(forKey: "iISubat19") as! Int
        }
        
        let iSubat19 = segue.destination as! ilkyardim17
        iSubat19.correctSubat19 = Int(correct)
        iSubat19.incorrectSubat19 = incorrect
        iSubat19.puanSubat19 = String((correct/13)*100)
    }
    ...
    func resultSave() {
        ...
        result.dersadi = "İlkyardım Şubat 2019 E-Sınav"
        result.tarih = tarihh
