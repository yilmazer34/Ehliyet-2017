...
class iNisan18: UIViewController, GADInterstitialDelegate   {
    
    var fullScreenads :GADInterstitial!
    
    let allQuestions = iNisan18Bank()
    ...
    var iNisan18 = ["null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null","null","null","null", "null","null","null","null"]
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        title = "İlk Yardım (21 Nisan 2018)"
        
        if defaults.object(forKey: "iNisan18") != nil {
            self.iNisan18 = defaults.object(forKey: "iNisan18") as! [String]
            UserDefaults.standard.synchronize()
        }
        
        if defaults.object(forKey: "viCNisan18") != nil {
            self.correct = defaults.object(forKey: "viCNisan18") as! Int
            UserDefaults.standard.synchronize()
        }
        
        if defaults.object(forKey: "viINisan18") != nil {
            self.incorrect = defaults.object(forKey: "viINisan18") as! Int
            UserDefaults.standard.synchronize()
        }
    ...
    @IBAction func answerPressed(_ sender: UIButton) {
        ...
        //        hav not SAVE .........................................................................
        if iNisan18[questionNumber] == "null" {
            ...
            if sender.tag == selectedAnswer {
                ...
                correctText.text = "Doğru: \(correct)"
                if sender.tag == 1 {
                    iNisan18[questionNumber] = "1"
                    defaults.set(iNisan18, forKey: "iNisan18")
                }
                if sender.tag == 2 {
                    iNisan18[questionNumber] = "2"
                    defaults.set(iNisan18, forKey: "iNisan18")
                }
                if sender.tag == 3 {
                    iNisan18[questionNumber] = "3"
                    defaults.set(iNisan18, forKey: "iNisan18")
                }
                if sender.tag == 4 {
                    iNisan18[questionNumber] = "4"
                    defaults.set(iNisan18, forKey: "iNisan18")
                }
            } else {
                print("wrong")
            ...
            if iNisan18[questionNumber] != String(selectedAnswer) {
                if sender.tag == selectedAnswer {
                    print("correct")
    ...
    func StartSave() {
        if optionA.tag == Int(iNisan18[questionNumber]) && selectedAnswer == 1 {
        ...
        if optionB.tag == Int(iNisan18[questionNumber]) && selectedAnswer == 2 {
            answerText.text = "Önceki Cevap: Doğru"
            answerText.textColor = UIColor(red: 0, green: 0.5686, blue: 0.0471, alpha: 1.0)
        }
        if optionB.tag == Int(iNisan18[questionNumber]) && selectedAnswer != 2 {
        ...
        if optionC.tag == Int(iNisan18[questionNumber]) && selectedAnswer == 3 {
            answerText.text = "Önceki Cevap: Doğru"
            answerText.textColor = UIColor(red: 0, green: 0.5686, blue: 0.0471, alpha: 1.0)
        }
        if optionC.tag == Int(iNisan18[questionNumber]) && selectedAnswer != 3 {
        ...
        if optionD.tag == Int(iNisan18[questionNumber]) && selectedAnswer == 4 {
            answerText.text = "Önceki Cevap: Doğru"
            answerText.textColor = UIColor(red: 0, green: 0.5686, blue: 0.0471, alpha: 1.0)
        }
        if optionD.tag == Int(iNisan18[questionNumber]) && selectedAnswer != 4 {
    ...
    func formating() {
        ...
        let ok = UIAlertAction(title: "EVET", style: UIAlertAction.Style.default, handler: {(action) -> Void in
            ...
            self.correct = 0
            self.incorrect = 0
            self.defaults.removeObject(forKey: "iNisan18")
            self.defaults.synchronize()
            self.correctText.text = "Doğru: \(self.correct)"
            self.wrongText.text = "Yanlış: \(self.incorrect)"
            self.iNisan18 = ["null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null", "null","null","null","null","null","null","null", "null","null","null","null"]
            if self.iNisan18[self.questionNumber] == "null" {
    ...
    func alert(){
        ...
        let ok = UIAlertAction(title: "TAMAM", style: UIAlertAction.Style.default, handler: {(action) -> Void in
            ...
            UserDefaults.standard.set(self.correct, forKey: "viCNisan18")
            UserDefaults.standard.synchronize()
            UserDefaults.standard.set(self.incorrect, forKey: "viINisan18")
            UserDefaults.standard.synchronize()
            self.resultSave()
            self.performSegue(withIdentifier: "siNisan18", sender: self)
        })
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if UserDefaults.standard.object(forKey: "viCNisan18") != nil {
            self.correct = UserDefaults.standard.object(forKey: "viCNisan18") as! Int
        }
        if UserDefaults.standard.object(forKey: "viINisan18") != nil {
            self.incorrect = UserDefaults.standard.object(forKey: "viINisan18") as! Int
        }
        let isubat18 = segue.destination as! ilkyardim17
        isubat18.correctNisan18 = correct
        isubat18.incorrectNisan18 = incorrect
        isubat18.puanNisan18 = String(correct*(100/13))
    }
    ...
    func resultSave() {
        ...
        result.dersadi = "21 Nisan 2018 İLK YARDIM"
        result.tarih = tarihh
